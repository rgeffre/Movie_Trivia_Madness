...
var questions = [
["Who was the first actor to be chosen as Indiana Jones", "Harrison Ford", "Peter Coyote", "Tom Selleck", "Tim Matheson", "C"],
...
["When translated from Italian who is Mr. Kiss Kiss Bang Bang" "James Bond", "Clint Eastwood", "Al Pacino", "Ethan Hunt" "A"]
];
...
function createQuestion () [
	...
	answers.innerHTML += <input type="radio" name="choices" value="A"> "+chA+<br>";
